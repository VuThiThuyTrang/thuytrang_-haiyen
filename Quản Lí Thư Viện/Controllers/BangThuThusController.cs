...
namespace Quản_Lí_Thư_Viện.Controllers
{
    public class BangThuThusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaThuThu,TenThuThu,DiaChi,MatKhau")] BangThuThu bangThuThu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaThuThu,TenThuThu,DiaChi,MatKhau")] BangThuThu bangThuThu)
        {
            if (ModelState.IsValid)
            {
